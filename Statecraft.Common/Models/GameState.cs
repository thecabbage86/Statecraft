...
namespace Statecraft.Common.Models
{
    public class GameState
    {
        ...
        public void InitializeMap()
        {
            ...
            Map.AddTerritory(new Territory(1, TerritoryName.Ankara, true, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(2, TerritoryName.Belgium, true, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(3, TerritoryName.Berlin, true, TerritoryType.Land, new Unit(Country.Germany, UnitType.Land), new List<Coast>()));
            Map.AddTerritory(new Territory(4, TerritoryName.Brest, true, TerritoryType.Land, new Unit(Country.France, UnitType.Sea), new List<Coast>()));
            ...
            Map.AddTerritory(new Territory(7, TerritoryName.Constantinople, true, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(8, TerritoryName.Denmark, true, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(9, TerritoryName.Edinburgh, true, TerritoryType.Land, new Unit(Country.England, UnitType.Sea), new List<Coast>()));
            Map.AddTerritory(new Territory(10, TerritoryName.Greece, true, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(11, TerritoryName.Holland, true, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(12, TerritoryName.Kiel, true, TerritoryType.Land, new Unit(Country.Germany, UnitType.Sea), new List<Coast>()));
            Map.AddTerritory(new Territory(13, TerritoryName.Liverpool, true, TerritoryType.Land, new Unit(Country.England, UnitType.Land), new List<Coast>()));
            Map.AddTerritory(new Territory(14, TerritoryName.London, true, TerritoryType.Land, new Unit(Country.England, UnitType.Sea), new List<Coast>()));
            Map.AddTerritory(new Territory(15, TerritoryName.Marseilles, true, TerritoryType.Land, new Unit(Country.France, UnitType.Land), new List<Coast>()));
            ...
            Map.AddTerritory(new Territory(18, TerritoryName.Naples, true, TerritoryType.Land, new Unit(Country.Italy, UnitType.Sea), new List<Coast>()));
            Map.AddTerritory(new Territory(19, TerritoryName.Norway, true, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(20, TerritoryName.Paris, true, TerritoryType.Land, new Unit(Country.France, UnitType.Land)));
            Map.AddTerritory(new Territory(21, TerritoryName.Portugal, true, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(22, TerritoryName.Rome, true, TerritoryType.Land, new Unit(Country.Italy, UnitType.Sea), new List<Coast>())); //*Italy may start with either a Fleet or Army in Rome.  Army is traditional, Fleet is recommended.
            Map.AddTerritory(new Territory(23, TerritoryName.Rumania, true, TerritoryType.Land, new List<Coast>()));
            ...
            Map.AddTerritory(new Territory(26, TerritoryName.Sevastopol, true, TerritoryType.Land, new Unit(Country.Russia, UnitType.Sea), new List<Coast>()));
            Map.AddTerritory(new Territory(27, TerritoryName.Smyrna, true, TerritoryType.Land, new List<Coast>()));
            ...
            Map.AddTerritory(new Territory(29, TerritoryName.Sweden, true, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(30, TerritoryName.Trieste, true, TerritoryType.Land, new Unit(Country.Austria, UnitType.Sea), new List<Coast>()));
            Map.AddTerritory(new Territory(31, TerritoryName.Tunis, true, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(32, TerritoryName.Venice, true, TerritoryType.Land, new Unit(Country.Italy, UnitType.Land), new List<Coast>()));
            ...
            Map.AddTerritory(new Territory(35, TerritoryName.Clyde, false, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(36, TerritoryName.Yorkshire, false, TerritoryType.Land));
            Map.AddTerritory(new Territory(37, TerritoryName.Wales, false, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(38, TerritoryName.Picardy, false, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(39, TerritoryName.Gascony, false, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(40, TerritoryName.Burgundy, false, TerritoryType.Land));
            Map.AddTerritory(new Territory(41, TerritoryName.NorthAfrica, false, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(42, TerritoryName.Ruhr, false, TerritoryType.Land));
            Map.AddTerritory(new Territory(43, TerritoryName.Prussia, false, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(44, TerritoryName.Silesia, false, TerritoryType.Land));
            Map.AddTerritory(new Territory(45, TerritoryName.Piedmont, false, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(46, TerritoryName.Tuscany, false, TerritoryType.Land));
            Map.AddTerritory(new Territory(47, TerritoryName.Apulia, false, TerritoryType.Land, new List<Coast>()));
            ...
            Map.AddTerritory(new Territory(51, TerritoryName.Finland, false, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(52, TerritoryName.Livonia, false, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(53, TerritoryName.Ukraine, false, TerritoryType.Land));
            Map.AddTerritory(new Territory(54, TerritoryName.Albania, false, TerritoryType.Land, new List<Coast>()));
            Map.AddTerritory(new Territory(55, TerritoryName.Armenia, false, TerritoryType.Land));
            Map.AddTerritory(new Territory(56, TerritoryName.Syria, false, TerritoryType.Land, new List<Coast>()));
